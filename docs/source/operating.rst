...
.. important::
   ...
   **not be valid if your [iotsolution-3f10] container is NOT running**.

.. tip::
   You must have your [iotsolution-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/smaurice101/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46873  \-\-env VIPERVIZPORT=34941  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:34941/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:34941/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 57749:57749 -p 44549:44549 -p 42825:42825 \-\-env TSS=0 \-\-env SOLUTIONNAME=iotsolution-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-iotsolution-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=57749  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=44549  \-\-env SOLUTIONVIPERVIZPORT=42825 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=46873 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=34941 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/iotsolution-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=42825
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=57749
...
It can be accessed by entering: http://localhost:44549
...
.. important::
   http://localhost:42825/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:42825/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:42825/<html file>
...
.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/iotsolution-3f10
...
.. important::
   solution_preprocessing_dag-iotsolution-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57749, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45221, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34207, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35007, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42443, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35209, HPDEHOST=127.0.1.1, HPDEPORT=39667, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33391

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-683-iotsolution-3f10,solution_preprocessing_dag-iotsolution-3f10, python-preprocess-7897-iotsolution-3f10,solution_preprocessing_dag-iotsolution-3f10, python-preprocess2-3431-iotsolution-3f10,solution_preprocessing_dag-iotsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
